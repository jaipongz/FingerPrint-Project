        ...
        <style>
         ...
         <div class="container">
            <div class="row">
                <div class="col-md-12">
<div align="right">                   
<form name="frmMain" method="POST" action="check_list.php" target="iframe_target" class="form-horizontal">

    <label for="textsearch" >ID</label>
    <input type="text" name="id" id="datepicker" placeholder="Please ID" autocomplete="off">
