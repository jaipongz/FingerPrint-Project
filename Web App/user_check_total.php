<?php
	...
	//day
	$strSQL = "SELECT SUM(inn), SUM(late), SUM(miss) FROM report WHERE id='".$_SESSION['ID']."' AND Year(date) = '$year' AND Month(date) = '$month' AND Day(date) = '$day'";
	...
	$strSQL = "SELECT SEC_TO_TIME(SUM(TIME_TO_SEC(time_all))), SEC_TO_TIME(SUM(TIME_TO_SEC(time_am))), SEC_TO_TIME(SUM(TIME_TO_SEC(time_pm))) FROM sum_time WHERE id='".$_SESSION['ID']."' AND Year(date) = '$year' AND Month(date) = '$month' AND Day(date) = '$day'";
	$objQuery = mysql_query($strSQL) or die (mysql_error());
	$result = mysql_query($strSQL);	
	while($row = mysql_fetch_array($result)){
	...
	//month
	$strSQL = "SELECT SUM(inn), SUM(late), SUM(miss) FROM report WHERE id='".$_SESSION['ID']."' AND Year(date) = '$year' AND Month(date) = '$month'";
	$objQuery = mysql_query($strSQL) or die (mysql_error());
	$result = mysql_query($strSQL);
	while($row = mysql_fetch_array($result)) {
		$all_in = $row['SUM(inn)'];
	...
	$strSQL = "SELECT SEC_TO_TIME(SUM(TIME_TO_SEC(time_all))), SEC_TO_TIME(SUM(TIME_TO_SEC(time_am))), SEC_TO_TIME(SUM(TIME_TO_SEC(time_pm))) FROM sum_time WHERE id='".$_SESSION['ID']."' AND Year(date) = '$year' AND Month(date) = '$month'";
	$objQuery = mysql_query($strSQL) or die (mysql_error());
	$result = mysql_query($strSQL);	
	while($row = mysql_fetch_array($result)){
	...
	//year
	$strSQL = "SELECT SUM(inn), SUM(late), SUM(miss) FROM report WHERE id='".$_SESSION['ID']."' AND Year(date) = '$year'";
	$objQuery = mysql_query($strSQL) or die (mysql_error());
	$result = mysql_query($strSQL);
	while($row = mysql_fetch_array($result)) {
		$in_year = $row['SUM(inn)'];
	...
	$strSQL = "SELECT SEC_TO_TIME(SUM(TIME_TO_SEC(time_all))), SEC_TO_TIME(SUM(TIME_TO_SEC(time_am))), SEC_TO_TIME(SUM(TIME_TO_SEC(time_pm))) FROM sum_time WHERE id='".$_SESSION['ID']."' AND Year(date) = '$year'";
	$objQuery = mysql_query($strSQL) or die (mysql_error());
	$result = mysql_query($strSQL);	
	while($row = mysql_fetch_array($result)){
