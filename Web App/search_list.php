<?php
	...
	//monthly
	$strSQL = "SELECT * FROM report WHERE id = '".$_SESSION['ID']."' AND Year(date) = '$year' AND Month(date) = '$month'";
	$objQuery = mysql_query($strSQL) or die (mysql_error());
	$result = mysql_query($strSQL);
...
<div class="col-md-14">
	...
	<table class="table table-striped">
		...
		<?php $i=1; while($objResult = mysql_fetch_array($objQuery)) { ?>
            <tr>
                <td><font face="Calibri" color="#009933" size="5"><b><?php echo $objResult['inn']; ?></font></td>
                <td><font face="Calibri" color="#009933" size="5"><b><?php echo $objResult['late']; ?></font></td>
                <td><font face="Calibri" color="#009933" size="5"><b><?php echo $objResult['miss']; ?></font></td>
